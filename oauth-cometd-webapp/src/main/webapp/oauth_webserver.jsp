...
<title>OAuth2 - CometD Webserver Authentication Flow POC</title>
<script
...
<script
  ...
  charset="utf-8">
	...
	$(function() {
		...
		var authUrl = "http://tbecker2.dyndns.org/oauth";
		...
		cometd.handshake({
			ext : {
				authentication : {
					oauthAccessToken : extractToken(document.location.hash).toString()
				}
			}
		});
	});
