...
public class OAuthValidateAccessTokenServlet extends HttpServlet
{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
    {
        ...
        out.println("<HTML><HEAD><TITLE>Hello Client!</TITLE>" + "</HEAD><BODY>Hello Client! Your token is: " + isValid + "</BODY></HTML>");
        out.close();
    }
